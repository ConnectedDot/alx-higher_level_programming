...
This project entailed object-oriented programming in Python. Getting hands on class methods, static methods, class vs instance attributes, andbhow to use the special `__str__` and `__repr__` methods.
